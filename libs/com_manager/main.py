...
from libs.com_manager.SerialManager_libs.serialmanager import SerialManager, SerialDeviceIdentifier
from libs.com_manager.SerialManager_libs.portmonitor import PortMonitor
