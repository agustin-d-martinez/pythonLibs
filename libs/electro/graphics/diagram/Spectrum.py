...
import copy
from .FreqComponent import FreqComponent, Delta, Block, Triangle, LeftTriangle, RightTriangle
from .FilterComponent import FilterComponent, BandPassFilter, BandStopFilter, LowPassFilter, HighPassFilter
...
class Spectrum:
    ...
    def addDelta(self, f_center, height=1.0, color='blue', name=None, x_text=None, **kwargs):
        ...
        **kwargs
        ...
        """
        self.add(Delta(f_center, height=height, color=color, name=name, x_text=x_text, **kwargs))
    ...
    def addBlock(self, f_center, width, height=1.0, color='skyblue', name=None, x_text=None, **kwargs):
        ...
        Returns:
            None
        """
        self.add(Block(f_center, width=width, height=height, color=color, name=name, x_text=x_text, **kwargs))
    ...
    def addTriangle(self, f_center, width, height=1.0, color='red', name=None, x_text=None, **kwargs):
        ...
        **kwargs
        ...
        None
        """
        self.add(Triangle(f_center, width=width, height=height, color=color, name=name, x_text=x_text, **kwargs))
    ...
    def addRightTriangle(self, f_center, width, height=1.0, color='orange', name=None, x_text=None, **kwargs):
        ...
        Returns:
            None
        """
        self.add(RightTriangle(f_center=f_center, width=width, height=height, color=color, name=name, x_text=x_text, **kwargs))
    ...
    def addLeftTriangle(self, f_center, width, height=1.0, color='orange', name=None, x_text=None, **kwargs):
        ...
        Returns:
            None
        """
        self.add(LeftTriangle(f_center=f_center, width=width, height=height, color=color, name=name, x_text=x_text, **kwargs))
    ...
    def addBandPassFilter(self, f_low=None, f_high=None, passband_gain=1.0, color='gray', name=None, x_text=None, **kwargs):
        ...
        **kwargs
        ...
        """
        self.add(BandPassFilter(f_low=f_low, f_high=f_high, passband_gain=passband_gain,
    ...
    def addBandStopFilter(self, f_low=None, f_high=None, passband_gain=1.0, color='gray', name=None, x_text=None, **kwargs):
        ...
        Returns:
            None
        """
        self.add(BandStopFilter(f_low=f_low, f_high=f_high, passband_gain=passband_gain,
                                color=color, name=name, x_text=x_text, **kwargs))
    def addLowPassFilter(self, f_cutoff, passband_gain=1.0, color='gray', name=None, x_text=None, **kwargs):
        ...
        **kwargs
        ...
        None
        """
        self.add(LowPassFilter(f_cutoff=f_cutoff, passband_gain=passband_gain,
                                color=color, name=name, x_text=x_text, **kwargs))
    def addHighPassFilter(self, f_cutoff, passband_gain=1.0, color='gray', name=None, x_text=None, **kwargs):
        ...
        """
        self.add(HighPassFilter(f_cutoff=f_cutoff, passband_gain=passband_gain,
                                color=color, name=name, x_text=x_text, **kwargs))
